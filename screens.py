...
def typing_tester_screen(stdscr):
    ...
    while True:
        ...
        if ord(key) == ENTER_KEY_ASCII:
            ...
            display_result(stdscr, elapsed_time, word_obj, user_text, no_of_backspaces)
            break


def display_result(
    stdscr, elapsed_time: float, word_obj: str, user_text: str, backspaces: int
):
